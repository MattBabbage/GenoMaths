...
fittest, score, best_array, average_array, q1_array, q3_array, fittest_array, timings  = genetic_algorithm(symbol_list, fitness, 50, 20, 0.8, 0.2, normalized_df.sample(n = 50))
